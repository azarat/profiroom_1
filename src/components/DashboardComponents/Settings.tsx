...
const Settings: React.FC = (): JSX.Element => {
  ...
  const scrollBtn = (e: any) : void => {
    if (e.target.id == 'next') {
      let left : any = tabMenu.current?.scrollLeft;
    ...
    <section className="setting__header">
      ...
      <div className='setting__tab'>
        <div className="setting__tab-btns">
          <div className="setting__tab-button setting__tab-button-left" onClick={scrollBtn} id="prev">
            <LeftOutlined />
          </div>
          <div className="setting__tab-button setting__tab-button-right" onClick={scrollBtn} id="next">
            <RightOutlined />
          </div>
        </div>
        ...
        <div className ="setting__main-form">
          ...
          >
            ...
            >
              ...
              <DatePicker className="setting__datapicker" defaultValue={moment('01/01/2015', dateFormatList[0])} format={dateFormatList} size="large"/>            
            </Form.Item>
            <Form.Item 
              name="aboutYourself"  
            ...
            >
              ...
              <TextArea className="setting__textarea" showCount maxLength={1200} autoSize={{minRows: 7} }/>      
            </Form.Item>
